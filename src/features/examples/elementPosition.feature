Feature: Test the position of a given element
   ...
   Scenario: The element #square100x100 is at XX pixels on the X axis
      Then  I expect that the attribute "offsetLeft" from element "#square100x100" is "25"

   Scenario: The element #square100x100 is at XX pixels on the Y axis
      Then  I expect that the attribute "offsetTop" from element "#square100x100" is "1086"

   Scenario: The element #square100x100 is not at YY pixels on the X axis
      Then  I expect that the attribute "offsetLeft" from element "#square100x100" is not "0"

   Scenario: The element #square100x100 is not at YY pixels on the y axis
      Then  I expect that the attribute "offsetTop" from element "#square100x100" is not "0"
